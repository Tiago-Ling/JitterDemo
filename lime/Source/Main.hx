...
class Main extends Application {
	...
	public override function init (context:RenderContext):Void {
		...
		positionX = (window.width - image.width) / 2;
		positionY = (window.height - image.height) / 2;
	...
	public override function update (deltaTime:Int):Void {
		...
		if (positionX + image.width < 0)
			positionX = window.width;
	...
	public override function render (context:RenderContext):Void {
		...
		switch (context) {
			...
			case OPENGL (gl):
				...
				var matrix:Matrix4 = Matrix4.createOrtho(0 - positionX, window.width - positionX, window.height - positionY, -positionY, -1000, 1000);
